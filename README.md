...
- `HumanGate.setVerifier(WorldIdV4Gate)` (owner only, emits `VerifierUpdated`): from then on only wallets registered after a World ID **4.0** Proof of Human can fund **new** leases. Same escrow address, no redeploy. Setting it back to `address(0)` reopens the gate. **This is live since Sat 12:09 JST.**
...
**Live:** the Sepolia escrow's gate is `HumanGate` [`0xFF6850c48B55d3d4a1e21b8562F15c653a3c3abd`](https://eth-sepolia.blockscout.com/address/0xFF6850c48B55d3d4a1e21b8562F15c653a3c3abd) (owner: the deployer). Its verifier is a `WorldIdV4Gate` since Sat 12:09 JST ([`setVerifier` tx `0x56b47b25…43e8ee`](https://sepolia.etherscan.io/tx/0x56b47b25c08ecec6022814b78273d2568bc7a8a4bea4eb6b4dda04180543e8ee), block 11783482), so **only registered wallets can fund**. `cast call 0xFF6850c48B55d3d4a1e21b8562F15c653a3c3abd "verifier()(address)"` shows which gate; both are in the Live on Ethereum Sepolia table below.
...
| `WorldIdV4Gate` (action `fund-lease`) | `0x27052bD69b3d961940bCD093C21ba729b6c1B209` | [Etherscan](https://sepolia.etherscan.io/address/0x27052bD69b3d961940bCD093C21ba729b6c1B209) · [Blockscout](https://eth-sepolia.blockscout.com/address/0x27052bD69b3d961940bCD093C21ba729b6c1B209) | [`0xf6009731…a199c`](https://sepolia.etherscan.io/tx/0xf6009731cf6bd6431914961d33746cc7bfc8cd626e730f31df0f333d0a6a199c) | [Sourcify](https://repo.sourcify.dev/11155111/0x27052bD69b3d961940bCD093C21ba729b6c1B209) exact match |
...
- `HumanGate`: owner = the deployer. `verifier` = `WorldIdV4Gate` `0x27052bD69b3d961940bCD093C21ba729b6c1B209` since Sat 12:09 JST ([tx `0x56b47b25…43e8ee`](https://sepolia.etherscan.io/tx/0x56b47b25c08ecec6022814b78273d2568bc7a8a4bea4eb6b4dda04180543e8ee)), so `fundLease` reverts `NotVerifiedHuman` for any wallet not registered there. No wallet is registered on that gate: its only phone proof for `fund-lease` was spent off-chain. The second gate `0x5Cb885E6292003492932f3fa647A9d6Bf8A4aABa` (action `fund-lease-wallet`, same RP signer) has alice `0x4848…e936` registered ([tx `0xdbbfc6dd…148908`](https://sepolia.etherscan.io/tx/0xdbbfc6dd08fdaa4da200b51e6515a7b60423a7c3f94feb06f4a3b28f65148908), block 11783569); pointing the `HumanGate` at it is one more `setVerifier` from the gate owner.
