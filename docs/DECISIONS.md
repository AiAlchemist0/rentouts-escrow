...
| [10](#adr-10-world-id-behind-a-human-gate-seam-that-only-gates-new-funding) | World ID behind a human-gate seam that only gates new funding | accepted, live; `WorldIdV4Gate` is the verifier since Sat 12:09 JST ([ADR-12](#adr-12-world-id-40-through-an-rp-signed-registration-gate)) |
| [12](#adr-12-world-id-40-through-an-rp-signed-registration-gate) | World ID 4.0 through an RP-signed registration gate | accepted, live (Sat 12:09 JST) |
