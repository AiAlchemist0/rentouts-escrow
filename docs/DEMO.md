...
5. **The AI arbiter is wired.** These reads should print the escrow, the judge address and the human arbiter:
   ...
   cast call ${ARB} "agent()(address)"  --rpc-url ${SEPOLIA_RPC_URL}   # = 0x4a444685F3E700D0d5B8Fe53d987f8029cced0dA (rentouts-judge)
